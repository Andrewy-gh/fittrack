...
func Middleware(next http.Handler, logger *slog.Logger, jwks *JWKSCache, userService *user.Service) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		userID, err := jwks.GetUserIDFromToken(accessToken)
		if err != nil {
		...
		dbUser, err := userService.EnsureUser(r.Context(), userID)
		if err != nil {
