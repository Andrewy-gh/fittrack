...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/aichat.ValidateRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/aichat.ValidateResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/aichat.ConversationDetail"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/aichat.SendMessageRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ai/conversations/{id}/runs/{runID}/stop": {
            "post": {
                "security": [
                    {
                        "StackAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/aichat.StopRunResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/featureaccess.FeatureAccessResponse"
                            }
                        }
                    },
                    "401": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/trainingprofile.ProfileResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/trainingprofile.UpdateProfileRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "trainingprofile.ProfileResponse": {
            "type": "object",
            "properties": {
                "available_equipment": {
                    "type": "array",
        ...
        "trainingprofile.UpdateProfileRequest": {
            "type": "object",
            "properties": {
                "available_equipment": {
                    "type": "array",
