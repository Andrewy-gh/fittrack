          ...
          <CollapsibleContent>
            <CardContent className="pt-4">
              <ContributionGraphContent
                ...
                workoutIdsByDate={workoutIdsByDate}
                workoutDetailsById={workoutDetailsById}
                navigate={navigate}
...
interface ContributionGraphContentProps {
  activities: Activity[];
  workoutIdsByDate: Map<string, number[]>;
  workoutDetailsById: Map<
    number | undefined,
    {
      id: number | undefined;
