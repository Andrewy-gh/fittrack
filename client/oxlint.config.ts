...
export default defineConfig({
  ...
  overrides: [
    ...
    {
      files: ["src/lib/local-storage.ts"],
      rules: {
        // The generated API type models the serialized string, while storage consumers
        // rehydrate the value as a Date. Keep the existing documented adapter assertion.
        "anti-slop/no-chained-type-assertions": "off",
      },
    },
    {
