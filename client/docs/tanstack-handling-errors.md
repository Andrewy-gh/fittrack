...
## [The route loading lifecycle](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#the-route-loading-lifecycle)
...
## [To Router Cache or not to Router Cache?](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#to-router-cache-or-not-to-router-cache)
...
Tip
If you know right away that you'd like to or need to use something more robust like TanStack Query, skip to the [External Data Loading](https://tanstack.com/router/v1/docs/framework/react/guide/external-data-loading) guide.

## [Using the Router Cache](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#using-the-router-cache)

The router cache is built-in and is as easy as returning data from any route's loader function. Let's learn how!

## [Route loaders](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#route-loaders)
...
## [loader Parameters](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#loader-parameters)
...
## [Consuming data from loaders](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#consuming-data-from-loaders)
...
## [Dependency-based Stale-While-Revalidate Caching](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#dependency-based-stale-while-revalidate-caching)
...
### [Key options](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#key-options)
...
### [⚠️ Some Important Defaults](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#️-some-important-defaults)
...
### [Using loaderDeps to access search params](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#using-loaderdeps-to-access-search-params)
...
### [Using staleTime to control how long data is considered fresh](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#using-staletime-to-control-how-long-data-is-considered-fresh)
...
## [Turning off stale-while-revalidate caching](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#turning-off-stale-while-revalidate-caching)
...
## [Using shouldReload and gcTime to opt-out of caching](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#using-shouldreload-and-gctime-to-opt-out-of-caching)
...
### [Opting out of caching while still preloading](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#opting-out-of-caching-while-still-preloading)
...
## [Passing all loader events to an external cache](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#passing-all-loader-events-to-an-external-cache)

We break down this use case in the [External Data Loading](https://tanstack.com/router/v1/docs/framework/react/guide/external-data-loading) page, but if you'd like to use an external cache like TanStack Query, you can do so by passing all loader events to your external cache. As long as you are using the defaults, the only change you'll need to make is to set the defaultPreloadStaleTime option on the router to 0:
tsx
...
## [Using Router Context](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#using-router-context)
...
## [Using Path Params](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#using-path-params)
...
## [Using Route Context](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#using-route-context)
...
## [Using Search Params in Loaders](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#using-search-params-in-loaders)
...
### [Accessing Search Params via routeOptions.loaderDeps](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#accessing-search-params-via-routeoptionsloaderdeps)
...
## [Using the preload flag](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#using-the-preload-flag)
...
## [Handling Slow Loaders](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#handling-slow-loaders)
...
- Split up your fast and slow data into separate promises and defer the slow data until after the fast data is loaded (see the [Deferred Data Loading](https://tanstack.com/router/v1/docs/framework/react/guide/deferred-data-loading) guide).
- Show a pending component after an optimistic suspense threshold until all of the data is ready (See below).

## [Showing a pending component](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#showing-a-pending-component)
...
## [Avoiding Pending Component Flash](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#avoiding-pending-component-flash)
...
## [Handling Errors](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#handling-errors)
...
### [Handling Errors with routeOptions.onError](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#handling-errors-with-routeoptionsonerror)
...
### [Handling Errors with routeOptions.onCatch](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#handling-errors-with-routeoptionsoncatch)
...
### [Handling Errors with routeOptions.errorComponent](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#handling-errors-with-routeoptionserrorcomponent)
...
### [Using the default ErrorComponent](https://tanstack.com/router/v1/docs/framework/react/guide/data-loading#using-the-default-errorcomponent)
...
[Custom Links](https://tanstack.com/router/v1/docs/framework/react/guide/custom-link)
